...
const data = [
    {
        ...
        desc: 'We believe that every individual deserves the opportunity to express themselves confidently and connect with others effectively. Through personalized care, evidence-based techniques, and unwavering dedication, we strive to help our clients overcome speech challenges, whether it’s stuttering, articulation difficulties, or language delays. Our commitment extends beyond therapy sessions; we work collaboratively with families, educators, and the community to create an inclusive environment where communication flourishes. Join us on this transformative journey as we unlock the potential within each person’s voice. Together, we build bridges of understanding, empathy, and connection.',
        img: kidsAtTable,
    },
    {
        title: 'My Expertise',
